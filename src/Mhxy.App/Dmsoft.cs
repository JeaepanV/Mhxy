...
public class Dmsoft
{
    ...
    public string FindStrWithFontE(
        int x1,
        int y1,
        int x2,
        int y2,
    ...
    public string FindStrWithFontEx(
        int x1,
        int y1,
        int x2,
        int y2,
